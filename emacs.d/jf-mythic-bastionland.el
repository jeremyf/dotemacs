...
(random-table/register
 ...
 :roller "2d6"
 :private t
 :data '(((2 . 12) . "{CURRENT_ROLL}")))
(random-table/register
 :name "Mythic Bastionland > Virtues > Young"
 :roller '(+ "1d6" "1d12")
 :private t
 :data '(((2 . 18) . "{CURRENT_ROLL}")))
(random-table/register
...
(random-table/scope
 ...
 (random-table/register
  :name "Courtly Conflict and Drama"
  :data '("A Love Triangle involving the knight is all the talk of the court."
          "A Secret Love Letter handed to the knight."
          "Request to intercede on a lover’s behalf, or to aid two other lovers."
          "A duel is proposed over a lover."
          "A messy break-up, and the consequences which follow."
          "An offer of marriage is made to the Knight."
          "A rival lord coming to court with a complaint, takes umbrage at the knight."
          "A friendly lord comes to court seeking aid, invoking the Knight’s name."
          "The Ruler in the Seat of Power visits with a personal request for the knight."
          "A knight or vassal of the court seeks legal arbitration by/against the knight."
          "An attempted assassination against the Knight or an associate!"
          "A War or petty martial conflict breaks out, the Knight is held responsible."
          "A Courtier has lost something and the Knight is somehow involved."
          "Two Courtiers vie with each other and involve the knight in their quarrel."
          "A Courtier makes moves on the Knight’s position in court."
          "A Courtier makes a gift to the knight, but it comes with expectations..."
          "A Courtier threatens to reveal a secret about the Knight."
          "A courtier feels personally insulted by the Knight and challenges them."
          "A sibling comes to Court, seeking to become the Knight’s Squire."
          "A sibling comes to Court after getting into some trouble with family or law."
          "A youth comes to court seeking recognition, claims to be the Knight’s child."
          "A parent or older relative comes to court in need of help."
          "An irritating older relative comes to court simply to visit them."
          "A relative is getting married and wishes the Knight to attend the wedding."
          "The knight is indoctrinated into a new religious cult in the court."
          "The knight is condemned as anathema by a religious group."
          "The knight is lauded as a saintly figure by a religious group."
          "The knight is asked to judge the worth of two different faiths by courtiers."
          "The knight has an unexplained vision or religious experience."
          "Something happens which causes the knight to question their own beliefs."
          "The Knight receives tidings of the nearest Myth."
          "A Courtier demands to hear the story of a Myth witnessed by the Knight."
          "The Seer who Knighted them summons them, they wish to test them..."
          "The Knight receives tidings of a random Myth."
          "A Random Seer summons the knight, claiming to have had a vision of them."
          "The Knight is involved with a new myth.")))
