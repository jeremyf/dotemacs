    ...
    (setq org-capture-templates
	  '(("@"
	    ...
	    ("m" "Merge Request"
	     ...
	     "***** TO-MERGE %^{URL of Merge Request} :mergerequest:"
	     :immediate-finish t
	     :jump-to-captured t
	     :empty-lines-after 1
	     )
...
#+begin_src emacs-lisp
  ...
  (cl-defun jf/org-mode-agenda-find-merge-request-node ()
    ...
    (jf/org-mode-agenda-find-project-node :tag "mergerequests" :project (concat "Merge Requests for " (format-time-string "%Y-%m-%d"))))
#+end_src
...
** Some Org-Roam Helper Functions
...
#+begin_src emacs-lisp
  ...
  (defun jf/org-mode-link-follow-link (id)
    ...
    (org-roam-node-visit (org-roam-node-from-id id) nil 'force))
#+end_src
