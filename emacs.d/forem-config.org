...
Pulling latest template for writing my end of week status report.

#+begin_src emacs-lisp
  (defvar jf/forem-eow-template "~/git/forem-internal-eng/.github/epic-progress-update.md")
  ...
  (cl-defun jf/forem-prepare-end-of-week-status-update (&key (template jf/forem-eow-template))
    ...
    (let* ((body (with-temp-buffer
		  ...
		  (buffer-string)))
	   (eow-buffer (get-buffer-create "*EoW Forem Update*")))
