...
#+begin_src emacs-lisp
  ...
  (transient-define-prefix jf/menu--forem ()
    ...
    [["Forem's Workflow"
     ...
     ["Jeremy's Workflow"
      ("a" "Authorization Project #46" (lambda () (interactive) (browse-url "https://github.com/orgs/forem/projects/46/views/1")))
      ("f" "Feed Operationalization Project #57" (lambda () (interactive) (browse-url "https://github.com/orgs/forem/projects/57")))
