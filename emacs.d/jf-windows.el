...
(mapc #'disable-theme custom-enabled-themes)
(setq jf-use-ef-themes t)

(if jf-use-ef-themes
  (progn
    (load "jf-ef-themes.el")
    (setq jf-dark-theme 'ef-elea-dark)
    (setq jf-light-theme 'ef-elea-light))
  (progn
    (load "jf-modus-themes.el")
    (setq jf-dark-theme 'modus-vivendi-tinted)
    (setq jf-light-theme 'modus-operandi-tinted)))
...
(defun jf/emacs-theme-by-osx-appearance ()
  ...
  (if (equal "Dark" (substring
                      ...
                      0 4))
    (load-theme jf-dark-theme)
    (load-theme jf-light-theme)))
